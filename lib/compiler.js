...
// Handlebars.registerPartial("component", (partial, options) => {
//     console.log(partial);
//     console.log(options);
// })
...
Compiler.preCompiling = (self) => {
    ...
    // console.log(preCompiledElement.innerHTML)
    // let tes = Handlebars.registerPartial(se)
    // console.log(tes)
    // preCompiledElement.innerHTML = Handlebars.precompile(preCompiledElement.innerHTML);
    // console.log(preCompiledElement.firstElementChild);
