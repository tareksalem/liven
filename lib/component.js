...
import { EventEmitter } from "liven/lib/liven";
...
class Component {
    constructor(props) {
        ...
        build(props) {
            ...
            props = Object.assign({}, props);
                ...
                let loopedComponents = props.loopedComponents || this.loopedComponents;
                props.loopedComponents = loopedComponents;
                this.loopedComponents = loopedComponents;
                // console.log(this.loopedComponents);
    ...
    // method to out child components
    outChildComponents() {
