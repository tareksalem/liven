...
class LivenJs {
    ...
    constructor() {
        ...
        this.DOM.getComponentsByIs = (is) => {
            let components = Object.values(this.DOM.components).filter(obj => obj.props.is == is || obj.props.type == is)
            return components;
        }
        ...
        this.redirect = routerObject.redirect;
